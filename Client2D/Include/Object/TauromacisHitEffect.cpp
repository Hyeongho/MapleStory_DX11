...
CTauromacisHitEffect::CTauromacisHitEffect(const CTauromacisHitEffect& obj) : CGameObject(obj)
{
...
void CTauromacisHitEffect::Start()
{
	...
	Anim->SetEndFunction<CTauromacisHitEffect>("TauromacisHitEffect", this, &CTauromacisHitEffect::AnimationFinish);
